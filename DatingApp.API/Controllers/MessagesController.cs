    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteMessage(int id, int userId){
            ...
            if (messagesFromRepo.RecipientId == userId)
                messagesFromRepo.RecipientDeleated = true;

            if(messagesFromRepo.SenderDeleated && messagesFromRepo.RecipientDeleated)
            ...
            throw new Exception("error deleating message");
        }
